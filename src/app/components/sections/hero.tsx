    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 text-amber-50">
        ...
        <a
          ...
          className="mt-8 px-6 py-3 bg-green-950 hover:bg-amber-50 transition-colors duration-300 hover:text-black text-white font-semibold rounded-xl inline-block"
        >
