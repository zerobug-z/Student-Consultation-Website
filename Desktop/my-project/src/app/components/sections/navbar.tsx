...
export default function Navbar(){
      ...
      <header className="sticky top-0 bg-amber-50 z-50 shadow">
        <nav className="w-full justify-between mx-auto px-5 md:flex items-center gap-6">
          ...
          <div className=" flex items-center justify-between md:w-auto w-full">
            <Link href="/">
            <img className="w-24 cursor-pointer h-auto" src="./UniwayLogo.png" alt="Uniway Logo" />
            </Link>
            {/*mobile menu icon */}
  ...
  isMobileMenuOpen ? "block" : "hidden"
            ...
            <Link href="/contactnpm" className="py-2 px-3 block hover:underline ">Bize Ulaşın</Link>
            <Link href="#" className="py-2 px-3 block hover:underline ">S.S.S.</Link>
            <Link href="#" className="py-2 px-3 block hover:underline bg-green-950 text-white font-semibold rounded-xl hover:bg-amber-400 hover:text-black transition duration-300 shadow-md ">Ücretsiz Ön Görüşme</Link>
          </div>
          {/*Dropdown menu */}
...
>
  ...
  <a className="block px-6 py-2 hover:bg-green-800 hover:underline" href="#">Lisans</a>
  <a className="block px-6 py-2 hover:bg-green-800 hover:underline" href="#">Yüksek Lisans</a>
  <a className="block px-6 py-2 hover:bg-green-800 hover:underline" href="#">Almanca Eğitimi</a>
</div>
